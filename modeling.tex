...
The second simulation (Fig. \ref{fig:vmax+pmin-2runs-init}, blue lines) also uses the same setup, except the initial sounding was determined by averaging every CFSR grid point within 1000 km of TC Patricia's storm center at 18 UTC 21 October 2015 instead of averaging only within the 100-km radius.
...
\caption{Vertical eddy diffusivity (m\textsuperscript{2} s\textsuperscript{-1}; filled contours), cold-point tropopause height (cyan lines), and radial velocity (m s\textsuperscript{-1}; thick black lines) averaged over (a) 0-24 hours, (b) 24-48 hours, and (c) 48-72 hours.}
\label{fig:diff}
\end{figure*}
