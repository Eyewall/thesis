...
%Alghough the less-rapid development in the 1000-km TC delays the strengthening of the lower-stratospheric stable layer, the $N^2$ evolution is quite similar once the RI begins.
...
Prescribing a smaller vertial mixing length (50 m) delays rapid intensification (Fig. \ref{fig:vmax+pmin-2runs-lv}, blue lines), but the final intensity of this storm closely matches that in the simulation that uses a 100-m mixing length (Fig. \ref{fig:vmax+pmin-2runs-lv}, red lines).
