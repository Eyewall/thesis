...
\cite{Molinarietal2014} examined bulk Richardson number ($R_b$) in TCs using National Oceanic and Atmospheric Administration (NOAA) Gulfstream-IV (G-IV) dropsondes.
